...
namespace DAM.Infrastructure.Security
{
    ...
    //{
        ...
        ///// </summary>
        //public JwtSecurityToken GenerateToken(string userName, string container, string assetKey)
        //{
