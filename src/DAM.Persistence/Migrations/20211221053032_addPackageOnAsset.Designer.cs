...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20211221053032_addPackageOnAsset")]
    partial class addPackageOnAsset
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 21, 5, 30, 31, 147, DateTimeKind.Unspecified).AddTicks(6109), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "DAM",
                            OrderNumber = 0
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Logo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 0,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 21, 5, 30, 31, 148, DateTimeKind.Unspecified).AddTicks(2264), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Theme", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 21, 5, 30, 31, 150, DateTimeKind.Unspecified).AddTicks(6108), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            IsApplied = true,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 21, 5, 30, 31, 150, DateTimeKind.Unspecified).AddTicks(7226), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = true,
                            IsApplied = false,
                            LogoFileName = "logo-simple",
                            LogoUrl = "https://damblob1.blob.core.windows.net/logocontainer-dev-mikey/logo-simple.png?sp=r&st=2021-11-11T04:38:10Z&se=2022-11-11T12:38:10Z&spr=https&sv=2020-08-04&sr=b&sig=P60UQSs6gi2%2BobEvkcZp%2BoY5DRCbqQnOsYI%2Fse0VVmY%3D",
