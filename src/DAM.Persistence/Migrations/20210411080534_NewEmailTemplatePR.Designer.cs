...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20210411080534_NewEmailTemplatePR")]
    partial class NewEmailTemplatePR
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 4, 11, 8, 5, 33, 419, DateTimeKind.Unspecified).AddTicks(9901), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "Dubber"
                        });
