...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20210411054716_NewEmailTemplateUV")]
    partial class NewEmailTemplateUV
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 4, 11, 5, 47, 15, 508, DateTimeKind.Unspecified).AddTicks(3410), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "Dubber"
                        });
