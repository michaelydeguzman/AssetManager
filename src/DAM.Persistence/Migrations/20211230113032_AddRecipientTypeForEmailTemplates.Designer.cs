...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20211230113032_AddRecipientTypeForEmailTemplates")]
    partial class AddRecipientTypeForEmailTemplates
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 30, 11, 30, 30, 509, DateTimeKind.Unspecified).AddTicks(6191), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "DAM",
                            OrderNumber = 0
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Logo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 0,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 30, 11, 30, 30, 511, DateTimeKind.Unspecified).AddTicks(9), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Theme", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 30, 11, 30, 30, 516, DateTimeKind.Unspecified).AddTicks(3641), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            IsApplied = true,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 30, 11, 30, 30, 516, DateTimeKind.Unspecified).AddTicks(6493), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = true,
                            IsApplied = false,
                            LogoFileName = "logo-simple",
                            LogoUrl = "https://damblob1.blob.core.windows.net/logocontainer-dev-mikey/logo-simple.png?sp=r&st=2021-11-11T04:38:10Z&se=2022-11-11T12:38:10Z&spr=https&sv=2020-08-04&sr=b&sig=P60UQSs6gi2%2BobEvkcZp%2BoY5DRCbqQnOsYI%2Fse0VVmY%3D",
