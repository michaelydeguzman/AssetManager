...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20211201051407_AddStylesCreateFields")]
    partial class AddStylesCreateFields
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 1, 5, 14, 6, 507, DateTimeKind.Unspecified).AddTicks(4059), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "DAM",
                            OrderNumber = 0
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Style", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 0,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 12, 1, 5, 14, 6, 510, DateTimeKind.Unspecified).AddTicks(8388), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            IsApplied = true,
                            Name = "Default",
