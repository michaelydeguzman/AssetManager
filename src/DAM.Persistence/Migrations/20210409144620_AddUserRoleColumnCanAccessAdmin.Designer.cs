...
namespace DAM.Persistence.Migrations
{
    ...
    [Migration("20210409144620_AddUserRoleColumnCanAccessAdmin")]
    partial class AddUserRoleColumnCanAccessAdmin
    {
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 4, 9, 14, 46, 18, 656, DateTimeKind.Unspecified).AddTicks(2927), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Description = "root",
                            FolderName = "Dubber"
                        });
