...
function ArchivedProjects(props) {
	...
	async function loadProjectsAndUsers() {
		var result = await props.getArchivedProjects();
...
function mapDispatchToProps(dispatch) {
	return {
		...
		getArchivedProjects: () => dispatch(getArchivedProjects()),
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(ArchivedProjects));
